...
// Merchants migrating from Mercanet V1 to Mercanet V2 must provide a transactionId. This is easily done below. (second example used as default).
...
//   "transactionReference" => "", // usefull for native Mercanet V2 merchantIds.  Merchants migrating from Mercanet V1 do provide s10TransactionId instead
   ...
   "instalmentData" => array(
      ...
      "datesList" => array('20210105','20210106','20210107'),  //Change the dates according to the time of the test of this use case - Modifiez les dates en fonction de l'heure du test de ce cas d'utilisation
      "s10TransactionIdsList" => array($s10TransactionId1,$s10TransactionId2,$s10TransactionId3)   //The first reference must be equal to the one contained in the transactionReference field - La première référence doit être égale à celle contenue dans le champ transactionReference
   ),
);
